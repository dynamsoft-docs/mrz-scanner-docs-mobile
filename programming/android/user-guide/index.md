...
This user guide will walk through the [QuickStartMRZScanner](https://github.com/Dynamsoft/mrz-reader-mobile/tree/main/android/Samples/QuickStartMRZScanner) sample app. When creating your own project, please use this sample as a reference. This guide uses RTU (Ready to Use) APIs which aim to elevate the UI creation process with less code and offer a more pleasant and intuitive UI for your app.
